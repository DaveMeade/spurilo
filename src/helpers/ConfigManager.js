...
class ConfigManager {
    ...
    async loadAllConfigs() {
        try {
            ...
            this.config.app = await this.loadJSON('/config/appSettings.json');
            this.config.debug = await this.loadJSON('/config/debugSettings.json');
            this.config.audit = await this.loadJSON('/config/auditSettings.json');
            this.config.compliance = await this.loadJSON('/config/complianceSettings.json');
